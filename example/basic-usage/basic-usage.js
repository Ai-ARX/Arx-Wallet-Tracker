...
function startTracking() {
    ...
    if (!address) {
        arx.showError('Please enter a wallet address');
        return;
    }
...
console.log('🔵 ARX Example Loaded');
console.log('This is a demonstration of ARX\'s core wallet tracking functionality');
